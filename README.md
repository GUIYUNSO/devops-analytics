...
### 用自然语言问一个关于代码仓库的问题，AI 自动采集数据、分析风险、追溯根因、给出建议

一个 Codex 插件，面向软件开发团队，提供自动化工程质量分析能力。
...
[⬆ 回到顶部](#工程智能代理eia) · [📥 安装](#快速安装) · [💬 提 Issue](https://github.com/GUIYUNSO/devops-analytics/issues)
